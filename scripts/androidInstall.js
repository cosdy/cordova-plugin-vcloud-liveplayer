...
module.exports = function (context) {
    ...
    var pluginSrcPath = path.join(context.opts.plugin.dir, "src/android/LivePlayerActivity.java");
    var platformSrcPath = path.join(projectRoot, "platforms", "android", "src/xwang/cordova/vcloud/liveplayer/LivePlayerActivity.java");
